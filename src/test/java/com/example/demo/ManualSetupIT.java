 ...
 /* @DynamicPropertySource
  ...
  void basicWireMockExample() {
    wireMockServer.stubFor(
      WireMock.get("https://api.hnb.hr/tecajn/v1?valuta=EUR")
        .willReturn(aResponse()
          .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
          .withBody("[{\"Broj tečajnice\": \"42\", "+ 
          		"\"Datum primjene\": \"02.03.2014\", "+ 
          		"\"Država\": \"Australija\", " + 
          		"\"Šifra valute\": \"036\", " + 
          		"\"Valuta\": \"AUD\", " + 
          		"\"Jedinica\": 1, " + 
          		"\"Kupovni za devize\": \"10,00\", " + 
          		"\"Srednji za devize\": \"10,00\", " + 
          		"\"Prodajni za devize\": \"10,00\" " + 
          		"} "+ 
          		"] "))
    );
